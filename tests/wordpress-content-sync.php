...
$assert(is_string($posts) && is_string($products) && is_string($woo) && is_string($variations) && is_string($terms) && is_string($abilities) && is_string($elementorDocuments) && is_string($abilitySync), 'Expanded content-operation source files could not be read.');
