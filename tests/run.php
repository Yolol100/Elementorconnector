...
$tests=[];
$valid=static fn()=>['title'=>'Home','type'=>'wp-page','version'=>'0.4','page_settings'=>[],'content'=>[['id'=>'abc123','elType'=>'container','isInner'=>false,'settings'=>[],'elements'=>[]]]];
...
$tests['payload-layout-isinner']=static function()use($valid,$throws):void{$p=$valid();unset($p['content'][0]['isInner']);$throws(static fn()=>(new PayloadValidator())->validate_array($p,'wp-page'));};
$tests['payload-layout-isinner-type']=static function()use($valid,$throws):void{$p=$valid();$p['content'][0]['isInner']='false';$throws(static fn()=>(new PayloadValidator())->validate_array($p,'wp-page'));};
